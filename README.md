...
### Project Contents
- **Developer Contents**
- [] 3D models for fishes and some coral reefs
- [x] circular slider ( for dishes section, touching screens are supported! )

- **User Contents**
- Information about the length of the fish, swimming locations, 3D models of the fish, its danger to humans, and more 
